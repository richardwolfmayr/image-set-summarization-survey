const page = (function () {
    ...
    function initHeader() {
        ...
        // titleDiv.append($(`<a href="../../wizard/index.html" class="button" style="margin-right: 10px;">Go to Interactive Table</a>`));
        ...
        // headerDiv.append($('<a href="../../wizard/index.html" class="button" style="margin-right: 10px;">Go to Interactive Table</a>'));
    }
